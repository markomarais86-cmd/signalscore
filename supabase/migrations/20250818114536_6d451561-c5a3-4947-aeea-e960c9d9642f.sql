-- Create materialized views first (needed for dashboard)
...
-- Create function to generate sample data for an organization
...
BEGIN
  ...
  (user_org_id, 'ACC006', 35, 30, 40, 35, '{"industry_match": false, "size_match": false, "revenue_match": false, "geography_match": true}', 'icp_v2.0'),
  (user_org_id, 'ACC007', 55, 60, 50, 55, '{"industry_match": false, "size_match": true, "revenue_match": true, "geography_match": false}', 'icp_v2.0'),
  (user_org_id, 'ACC008', 72, 70, 75, 70, '{"industry_match": true, "size_match": false, "revenue_match": true, "geography_match": false}', 'icp_v2.0'),
  (user_org_id, 'ACC009', 68, 65, 70, 70, '{"industry_match": false, "size_match": true, "revenue_match": true, "geography_match": false}', 'icp_v2.0'),
  (user_org_id, 'ACC010', 62, 60, 65, 60, '{"industry_match": false, "size_match": true, "revenue_match": true, "geography_match": false}', 'icp_v2.0')
  ...
  (user_org_id, 'LEAD006', 'HealthTech Partners - Compliance Solution', 'open'),
  (user_org_id, 'LEAD007', 'ManufacturingPro - IoT Platform', 'open'),
  (user_org_id, 'LEAD008', 'EdTech Solutions - Learning Platform', 'qualified'),
  (user_org_id, 'LEAD009', 'GreenEnergy Corp - Monitoring System', 'nurturing'),
  (user_org_id, 'LEAD010', 'LogisticsTech - Supply Chain Optimization', 'open')
  ON CONFLICT (org_id, external_id) DO NOTHING;
