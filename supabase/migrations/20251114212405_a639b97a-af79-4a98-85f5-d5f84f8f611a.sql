-- Fix get_filtered_accounts function to use correct table and column names
-- The function was referencing 'account_scores' table which doesn't exist
-- The actual table is 'scores' with column 'overall' not 'overall_score'
