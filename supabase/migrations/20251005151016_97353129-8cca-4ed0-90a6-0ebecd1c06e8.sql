-- Step 1: Create the missing unique constraint on normalized domain
...
-- Step 2: Update the match_leads_to_accounts_fast function with simplified conflict handling
...
BEGIN
  ...
  inserted_accounts AS (
    ...
    -- Simplified conflict handling - constraint will prevent domain duplicates
