-- Fix match_leads_to_accounts_fast with pre-filtering approach
-- This prevents duplicate key violations by filtering BEFORE insert
...
BEGIN
  ...
  -- Step 2: Create new accounts for unmatched leads with PRE-FILTERING
  ...
  -- NEW: Pre-filter to exclude domains that already exist
  ...
  inserted_accounts AS (
    ...
    -- Safe fallback in case of race conditions
