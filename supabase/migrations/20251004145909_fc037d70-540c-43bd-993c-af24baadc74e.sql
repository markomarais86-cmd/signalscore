-- Phase 6.1: Update match_leads_to_accounts_fast to handle external database attribution
-- This migration adds support for:
-- 1. Marking accounts from external databases as data_source = 'database'
-- 2. Updating existing CRM accounts to data_source = 'both' when matched
...
BEGIN
  ...
  IF p_is_external_db THEN
    WITH matched_accounts_for_update AS (
