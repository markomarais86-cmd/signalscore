-- Fix RLS permissions for match_leads_to_accounts_fast function
-- Ensure the function can be called by authenticated users and has proper security
...
DECLARE
  ...
  v_icp_id UUID;
BEGIN
  -- Note: SECURITY DEFINER allows this function to bypass RLS
  -- We validate org_id internally for security
