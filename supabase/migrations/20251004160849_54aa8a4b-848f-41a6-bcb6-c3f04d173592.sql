-- Fix duplicate domain constraint violation in match_leads_to_accounts_fast
-- Add proper ON CONFLICT handling for the unique constraint on normalized domains
...
BEGIN
  ...
  -- Step 2: Create new accounts for unmatched leads
  -- Use INSERT ... ON CONFLICT to handle duplicate domains gracefully
  ...
  inserted_accounts AS (
    ...
    -- Handle duplicate domains by doing nothing if they already exist
