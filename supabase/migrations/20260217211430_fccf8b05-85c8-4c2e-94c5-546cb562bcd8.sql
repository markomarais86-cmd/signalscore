...
BEGIN
  ...
  -- Child org: only count accounts that have been scored by this child org (INNER JOIN)
  SELECT 
  ...
  -- Leads: only count leads linked to scored accounts
  SELECT 
