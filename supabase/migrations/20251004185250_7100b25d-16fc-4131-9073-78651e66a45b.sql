-- Fix the ON CONFLICT constraint to target the correct unique index
...
BEGIN
  ...
  -- Use the CORRECT ON CONFLICT clause targeting the domain constraint
  ...
  inserted_accounts AS (
    ...
    -- Target the CORRECT constraint on normalized domain
