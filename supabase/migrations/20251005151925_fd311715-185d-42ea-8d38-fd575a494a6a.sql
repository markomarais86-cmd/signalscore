-- Fix ON CONFLICT syntax to work with unique index instead of constraint
...
BEGIN
  ...
  inserted_accounts AS (
    ...
    -- Use column-based ON CONFLICT syntax that works with unique index
    ON CONFLICT (org_id, normalize_domain_text(domain)) 
